...
const fetchTickets = async (page = 1) => {
    ...
    try {
        tickets.value = await getProjectTickets(project.value.id, perPage, page);
                ...
                <div class="p-4">
                    <div class="space-y-6">
                            ...
                            <div
                                ...
                                <div class="p-4">
                                    ...
                                    <ul class="mt-2 list-disc list-inside text-sm">
                                        <li>Open: {{ project.tickets_open ?? 0 }}</li>
                                        <li>In Progress: {{ project.tickets_in_progress ?? 0 }}</li>
                                        <li>Closed: {{ project.tickets_closed ?? 0 }}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="overflow-x-auto">
                            ...
                            <TicketsTable v-else :tickets="tickets?.data ?? []" :showProject="false" />
