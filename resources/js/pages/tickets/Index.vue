        ...
        >
            <div class="flex items-center justify-between">
                ...
                <div v-if="canCreateTickets">
                    <Link
                        :href="`/tickets/create`"
                        class="rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-sm hover:bg-primary/90 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none disabled:opacity-50"
                    >
                        Create Ticket
                    </Link>
                </div>
                ...
                <div class="p-4">
                    <div class="overflow-x-auto">
                        ...
                        >
                            ...
                            <p>
                                Showing {{ tickets?.meta?.from ?? 0 }} to
